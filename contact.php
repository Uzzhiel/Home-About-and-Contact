...
<body>
 ...
 <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">WebMapCSU</a></h1>
      ...
      <a href="courses.html" class="get-started-btn">Sign Out</a>
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
          ...
          <div class="col-lg-9">
            <div class="info">
              ...
              <div class="email">
                ...
                <p>Uzzhielanglelynn@gmail.com</p>
              </div>
      ...
      <div class="contact-div2" class="container"> 
      ...
      <div class="container" data-aos="fade-up" >
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/testimonials-2.jpg" class="img-fluid" alt="">
              <div class="member-content">
